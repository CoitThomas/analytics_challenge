defmodule AnalyticsChallenge.Pagecount do
  ...
  def changeset(pagecount, attrs) do
    ...
    |> validate_length(:language_code, min: 2, max: 3) # ISO 639-1s are length 2, ISO 639-2s are length 3
    |> validate_number(:view_count, greater_than: 0)
    |> validate_inclusion(:year, 2007..2016) # The Wiki pagecount files are only for the years 2007-2016
